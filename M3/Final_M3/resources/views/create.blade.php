                ...
                <div class="row d-flex">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="name" value="{{ old('name') }}" type="input" class="form-control" id="exampleInputEmail1">
                            <span class="text-danger">{{ $errors->first('name') }}</span>
                        </div>
                        <div class="mb-3">
                            <label for="isbn" class="form-label">ISBN</label>
                            <input name="isbn" value="{{ old('isbn') }}" type="input" class="form-control" id="isbn">
                            <span class="text-danger">{{ $errors->first('isbn') }}</span>
                        </div>
                        <div class="mb-3">
                            <label for="number_of_pages" class="form-label">number_of_pages</label>
                            <input name="number_of_pages" value="{{ old('number_of_pages') }}" type="input" class="form-control" id="number_of_pages">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="publishing_year" value="{{ old('publishing_year') }}" type="input" class="form-control" id="publishing_year">
