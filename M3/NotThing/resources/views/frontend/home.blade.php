...
@section('js')
<link rel="stylesheet" href="{{ asset('Frontend\custom\home\home.css') }}">
@endsection
@section('content')
    <!-- Slider -->
    <div class="container">
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="main_slider" style="background-image:url({{ asset('storage/images/slider/Screenshot.jpg') }})">
                ...
                <div class="carousel-item">
                    <div class="main_slider" style="background-image:url({{ asset('storage/images/slider/download.jpg') }})">
                        <div class="container fill_height">
                            <div class="row align-items-center fill_height">
                                <div class="col">
                                    <div class="main_slider_content">
